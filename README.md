...
- [Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos [Baker et al., 2022]](https://arxiv.org/abs/2206.11795): we use the same idea of an inverse dynamics model to recover actions from gameplay videos
...
- [Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos [Baker et al., 2022]](https://arxiv.org/abs/2206.11795)
- [Next Embedding Prediction Makes World Models Stronger [Bredis et al, 2026]](https://arxiv.org/abs/2603.02765)
...
- [V-JEPA 2: Self-Supervised Video Models Enable Understanding, Prediction and Planning [Assran et al., 2025]](https://www.arxiv.org/abs/2506.09985)
